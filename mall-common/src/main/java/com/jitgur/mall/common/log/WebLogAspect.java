package com.jitgur.mall.common.log;

import cn.hutool.core.util.StrUtil;
import cn.hutool.core.util.URLUtil;
import cn.hutool.json.JSONUtil;
import com.github.pagehelper.util.StringUtil;
import com.jitgur.mall.common.domain.WebLog;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.jitgur.mall.*.controller.*.*(..))")
    public void webLog() {
    }
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String strUtl = request.getRequestURL().toString();
        webLog.setBasePath(StrUtil.removeSuffix(strUtl, URLUtil.url(strUtl).getPath()));
        ...
        webLog.setStartTime((int) startTime);
    ...
    public Object getParameter(Method method, Object[] args) {
        ...
        else if (argList.size() == 1) return argList.get(0);
        else return argList;
    }
