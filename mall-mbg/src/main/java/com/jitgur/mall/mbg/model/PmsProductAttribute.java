...
public class PmsProductAttribute implements Serializable {
    ...
    @ApiModelProperty(value = "商品属性分类表id")
    ...
    @ApiModelProperty(value = "属性录入类型 0>手工录入 1>从列表中选取")
    private Integer inputType;

    @ApiModelProperty(value = "可选值列表，以逗号分隔")
    ...
    @ApiModelProperty(value = "相同属性商品是否关联 0>不关联 1>关联")
    private Integer relatedStatus;

    @ApiModelProperty(value = "是否支持手动新增属性 0>不支持 1>支持")
    private Integer handAddStatus;

    @ApiModelProperty(value = "属性类型 0>规格 1>参数")
