...
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty(value = "商品品牌表id")
    ...
    @ApiModelProperty(value = "新品状态 0>非新品 1>新品")
    ...
    @ApiModelProperty(value = "商品重量，单位g")
    private BigDecimal weight;

    @ApiModelProperty(value = "是否为预告商品 0>不是 1>是")
    private Integer previewStatus;

    @ApiModelProperty(value = "以逗号分隔的商品服务 1>无忧退货 2>快速退款 3>免费包邮")
    ...
    @ApiModelProperty(value = "连同商品图片限制为5张，以逗号分隔")
