...
public class SmsCoupon implements Serializable {
    ...
    @ApiModelProperty(value = "优惠券类型 0>全场赠送 1>会员赠送 2>购物赠送 3>注册赠送")
    private Integer type;

    private String name;

    @ApiModelProperty(value = "使用平台 0>全平台 1>移动 2>pc")
    ...
    @ApiModelProperty(value = "适用类型 0>全场通用 1>指定分类 2>指定商品")
    ...
    @ApiModelProperty(value = "截至领取时间")
    private Date enableTime;

    @ApiModelProperty(value = "优惠券编码")
    private String code;

    @ApiModelProperty(value = "可领取会员等级 0>无限制")
